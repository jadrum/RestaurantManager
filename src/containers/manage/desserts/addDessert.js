...
import { addDessert } from '../../../actions/manage/desserts';
import {
  Button,
  Col,
  ControlLabel,
...
class AddDessert extends Component {
  constructor(props, context) {
    ...
    this.state = {
      ...
      priceError: '',
      desc: '',
      image: null // image for dessert and firebase
    };
  }
  ...
  submitDessert = e => {
    ...
    this.props.addDessert({
      name: this.state.name,
      price: this.state.price,
      desc: this.state.desc,
      image: this.state.image,
      imageUrl: '/img/desserts/default.jpg',
      imageRef: null
    });
    this.setState({ name: '' });
    this.setState({ price: '' });
      ...
      <div>
        <Modal show={this.props.showAddModal} onHide={this.props.closeAdd}>
          <Modal.Header closeButton>
            <Modal.Title>Create dessert</Modal.Title>
          </Modal.Header>
...
export default connect(mapStateToProps, { addDessert })(AddDessert);
